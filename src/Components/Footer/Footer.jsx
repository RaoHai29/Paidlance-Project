      ...
      <Container maxWidth="lg">
        <Grid container spacing={7}>
          <Grid item xs={12} sm={3}>
            <Typography variant="h6" color="white" gutterBottom sx={{fontSize:'42px',marginTop:"-28px",fontWeight:'700'}}>
          ...
          <Grid item xs={12} sm={3}>
            ...
            <Stack direction='row'>
                <input type="email" name="email" id="email" value='Enter your Email' style={{height:'30px', padding:'5px 10px', fontSize:'15px', borderRadius:'10px',borderEndEndRadius:'0',borderTopRightRadius:'0', border:'1px solid transparent'}} />
                <Button variant="contained" sx={{padding:'8px 50px',borderRadius:'10px',borderTopLeftRadius:'0',borderEndStartRadius:'0',background:'#0077FF',textTransform:'capitalize', fontSize:'14.5px'}}>Submit</Button>
            </Stack>
          </Grid>
        </Grid>
